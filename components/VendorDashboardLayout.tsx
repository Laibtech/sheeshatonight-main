...
export const VendorDashboardLayout: React.FC<VendorDashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: 'Orders', icon: ShoppingBag, href: '/vendor/orders', badge: 3 },
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  <p className="text-sm font-semibold text-slate-900">{userName || 'Vendor'}</p>
              ...
              {userMenuOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-50">
                  <div className="px-4 py-3 border-b border-slate-100">
                    <p className="text-sm font-semibold text-slate-900">{userName || 'Vendor'}</p>
                    <p className="text-xs text-slate-500">{userEmail || 'vendor@example.com'}</p>
                  </div>
                  <button
