...
export default function LandingPage() {
  ...
  const activeTestimonialItem = testimonials[activeTestimonial] ?? testimonials[0];
  if (!activeTestimonialItem) return null;
      ...
      <section className="bg-white py-20 px-6">
        <div className="container mx-auto">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="mb-8">
              <img 
                src={activeTestimonialItem.img} 
                alt={activeTestimonialItem.name}
                className="w-32 h-32 rounded-full mx-auto mb-6 border-4 border-blue-500"
              />
              <p className="text-xl text-slate-700 mb-6 italic">"{activeTestimonialItem.text}"</p>
              <h3 className="font-bold text-lg">{activeTestimonialItem.name}</h3>
              <p className="text-blue-500 uppercase text-sm">{activeTestimonialItem.role}</p>
            </div>
            ...
            <div className="flex justify-center gap-4">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img src={testimonial.img} alt="" className="w-full h-full object-cover" />
                </button>
              ))}
            </div>
          </div>
